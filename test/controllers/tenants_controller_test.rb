...
class TenantsControllerTest < ActionController::TestCase
  ...
  test "should create tenant" do
    assert_difference('Tenant.count') do
      post :create, tenant: { description: @tenant.description, name: @tenant.name, slug: @tenant.slug }
    end
  ...
  test "should update tenant" do
    patch :update, id: @tenant, tenant: { description: @tenant.description, name: @tenant.name, slug: @tenant.slug }
    assert_redirected_to tenant_path(assigns(:tenant))
  end
